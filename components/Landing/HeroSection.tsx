    ...
    <section className="heroSection">
      ...
      <motion.div className="heroContent">
        ...
        >
          ...
          <a href="https://discord.gg/5YhHQUm8B3" target="_blank" rel="noopener noreferrer" className="heroSocialLink" aria-label="Discord">
          ...
          <a href="https://t.me/antedotwtf" target="_blank" rel="noopener noreferrer" className="heroSocialLink" aria-label="Telegram">
