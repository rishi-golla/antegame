...
const TIERS: Record<MinigameTier, {
  ...
  win: {
    label: 'Jackpot!',
    subtitle: { buying: 'Free property', rent: 'Rent dodged' },
    color: '#ffd700',
  ...
  'close-win': {
    label: 'Close Win',
    subtitle: { buying: 'Half price', rent: 'Lucky break' },
    color: '#4ade80',
  ...
  'close-loss': {
    label: 'Close Call',
    subtitle: { buying: 'Overcharged', rent: 'Surcharge' },
    color: '#fbbf24',
  ...
  loss: {
    label: 'You Lost',
    subtitle: { buying: 'Double penalty', rent: 'Double rent' },
    color: '#f87171',
  ...
  catastrophic: {
    label: 'Disaster',
    subtitle: { buying: 'Catastrophic', rent: 'Ruinous' },
    color: '#ef4444',
