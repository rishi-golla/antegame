...
export const TILES: Tile[] = [
  /* 0  */ corner(0, 'GO', 'go'),
  /* 1  */ prop(1, 'Coral Street', 'brown', 60, [2, 4, 10, 30, 90, 160, 250], 50),
  /* 2  */ chest(2),
  /* 3  */ prop(3, 'Mint Avenue', 'brown', 60, [4, 8, 20, 60, 180, 320, 450], 50),
  /* 4  */ tax(4, 'Income Tax', 200),
  /* 5  */ rr(5, 'North Rail'),
  /* 6  */ prop(6, 'Lemon Square', 'light-blue', 100, [6, 12, 30, 90, 270, 400, 550], 50),
  /* 7  */ chance(7),
  /* 8  */ prop(8, 'Clover Drive', 'light-blue', 100, [6, 12, 30, 90, 270, 400, 550], 50),
  /* 9  */ prop(9, 'Sunset Blvd', 'light-blue', 120, [8, 16, 40, 100, 300, 450, 600], 50),
  /* 10 */ corner(10, 'Jail', 'jail'),
  /* 11 */ prop(11, 'Orchid Lane', 'pink', 140, [10, 20, 50, 150, 450, 625, 750], 100),
  /* 12 */ util(12, 'Electric Co'),
  /* 13 */ prop(13, 'Lake View', 'pink', 140, [10, 20, 50, 150, 450, 625, 750], 100),
  /* 14 */ prop(14, 'Rosewood Pl', 'pink', 160, [12, 24, 60, 180, 500, 700, 900], 100),
  /* 15 */ rr(15, 'East Rail'),
  /* 16 */ prop(16, 'Maple Park', 'orange', 180, [14, 28, 70, 200, 550, 750, 950], 100),
  /* 17 */ chest(17),
  /* 18 */ prop(18, 'Cherry Row', 'orange', 180, [14, 28, 70, 200, 550, 750, 950], 100),
  /* 19 */ prop(19, 'Oak Crest', 'orange', 200, [16, 32, 80, 220, 600, 800, 1000], 100),
  /* 20 */ corner(20, 'Free Parking', 'free-parking'),
  /* 21 */ prop(21, 'Ruby Row', 'red', 220, [18, 36, 90, 250, 700, 875, 1050], 150),
  /* 22 */ chance(22),
  /* 23 */ prop(23, 'Pearl Street', 'red', 220, [18, 36, 90, 250, 700, 875, 1050], 150),
  /* 24 */ prop(24, 'Hill Crest', 'red', 240, [20, 40, 100, 300, 750, 925, 1100], 150),
  /* 25 */ rr(25, 'West Rail'),
  /* 26 */ prop(26, 'Luna Avenue', 'yellow', 260, [22, 44, 110, 330, 800, 975, 1150], 150),
  /* 27 */ prop(27, 'Garden Street', 'yellow', 260, [22, 44, 110, 330, 800, 975, 1150], 150),
  /* 28 */ util(28, 'Water Works'),
  /* 29 */ prop(29, 'Willow Drive', 'yellow', 280, [24, 48, 120, 360, 850, 1025, 1200], 150),
  /* 30 */ corner(30, 'Go To Jail', 'go-to-jail'),
  /* 31 */ prop(31, 'Plaza Way', 'green', 300, [26, 52, 130, 390, 900, 1100, 1275], 200),
  /* 32 */ prop(32, 'Birch Point', 'green', 300, [26, 52, 130, 390, 900, 1100, 1275], 200),
  /* 33 */ chest(33),
  /* 34 */ prop(34, 'River Side', 'green', 320, [28, 56, 150, 450, 1000, 1200, 1400], 200),
  /* 35 */ rr(35, 'South Rail'),
  /* 36 */ chance(36),
  /* 37 */ prop(37, 'Golden Road', 'dark-blue', 350, [35, 70, 175, 500, 1100, 1300, 1500], 200),
  /* 38 */ tax(38, 'Luxury Tax', 100),
  /* 39 */ prop(39, 'Park Lane', 'dark-blue', 400, [50, 100, 200, 600, 1400, 1700, 2000], 200),
];
...
export const CHANCE_CARDS: Card[] = [
  ...
  { id: 'ch-14', deckType: 'chance', text: 'Take a trip to North Rail. If you pass GO, collect $200.', effect: { kind: 'move-to', tileIndex: 5 } },
